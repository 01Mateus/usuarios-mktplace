...
public class UsuarioService {
	...
	public Usuario atualizarPor(String login, String nomeCompleto, 
		...
		Preconditions.checkNotNull(usuarioSalvo, "Não foi encontrado "
				+ "usuário vinculado ao login informado");
		...
		Preconditions.checkArgument(senhaAntiga.equals(senhaNova),
				"A senha nova não pode ser igual a senha anterior");
	...
	public Usuario buscarPor(String login) {
		...
		Preconditions.checkNotNull(usuarioEncontrado, 
				"Não foi encontrado usuário vinculado ao login informado");
